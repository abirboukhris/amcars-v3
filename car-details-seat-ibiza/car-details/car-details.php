...
<!--<header class="header">
    <nav class="collapse">
        ...
        <//car-details-seat-ibiza
</header>-->
<section class="titre">
    <div class="modele"><h3 class="nomv">SEAT IBIZA </h3></div>
</section>
<section class="details">

    <div class="image">
        <div class="slider">
            <img src="/car-details-seat-ibiza/car-details/img/image1.jpg" >
            <img src="/car-details-seat-ibiza/car-details/img/image2.jpg" >
            <img src="/car-details-seat-ibiza/car-details/img/image3.jpg" >
